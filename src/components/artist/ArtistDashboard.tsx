    ...
    try {
      ...
      if (serviceImages && serviceImages.length > 0) {
        ...
        try {
          ...
          (serviceData as any).image = uploaded[0] || '';
          (serviceData as any).cover = uploaded[0] || '';
                ...
                <View style={styles.profileInfo}>
                  ...
                  <View style={styles.ratingContainer}>
                    ...
                    {artistProfile.reviewsCount === 0 ? (
                      ...
                      <>
                        {Array.from({ length: 5 }).map((_, i) => {
                          const rating = artistProfile.rating || 0;
                          return (
                        ...
                        <Text style={styles.ratingText}>
                          {(artistProfile.rating || 0).toFixed(1)} ({artistProfile.reviewsCount} reviews)
                        </Text>
                      </>
                    )}
                  </View>
  ...
  return (
    <View style={[styles.mainContainer, { backgroundColor: '#f5f5f5' }]}> {/* Remove violet color from safe area */}
      ...
      <View style={[styles.tabBar, { paddingBottom: insets.bottom }]}> 
        ...
        >
          <Ionicons name="pricetag" size={24} color={activeTab === 'promo' ? '#6a0dad' : '#666'} />
          <Text style={[styles.tabText, activeTab === 'promo' && styles.activeTabText]}>Promo</Text>
        </TouchableOpacity>
        <TouchableOpacity 
