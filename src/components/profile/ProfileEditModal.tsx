...
import { AlertCircle, Camera, CheckCircle, Eye, EyeOff, Lock, Mail, Phone, User, X } from 'lucide-react-native';
...
export const ProfileEditModal: React.FC<ProfileEditModalProps> = ({
  ...
  const [currentStep, setCurrentStep] = useState(0); // 0: Basic Info, 1: Password Change
