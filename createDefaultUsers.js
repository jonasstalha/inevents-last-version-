/**
 * Create Default Test Users for inevents Firebase Project
...
async function createDefaultUsers() {
  try {
    console.log('🔥 Creating default test users for inevents project...');
    ...
    console.log(`📝 Creating ${defaultUsers.length} default users...`);
