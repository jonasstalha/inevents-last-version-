...
const PublicProfile = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#faf8ff' }}>
                    ...
                    {!isOwnProfile && (
                      <View style={{flexDirection:'row', justifyContent:'space-between', marginTop:12}}>
                        <TouchableOpacity 
                          ...
                          onPress={() => {
                            // Navigate to chat or contact functionality
                            console.log('Contact artist with service:', service.id);
                          }}
                        >
                          <Text style={{color:'#fff', fontWeight:'bold', fontSize:14}}>
                            <Ionicons name="chatbubble-outline" size={16} color="#fff" /> Contact Artist
                          </Text>
                        </TouchableOpacity>
      ...
      {/* Contact Artist Button - Only show for other artists' profiles */}
      {!isOwnProfile && artistProfile && (
        <TouchableOpacity 
          ...
          onPress={() => {
            // Navigate to chat or contact functionality
            console.log('Contact artist:', params.id);
            // TODO: Implement chat navigation or contact modal
          }}
        >
