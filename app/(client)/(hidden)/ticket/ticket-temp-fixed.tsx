...
export default function TicketDetailScreen() {
  ...
  // Update total price based on selected tickets and promo code
  ...
  const handleTicketQuantityChange = useCallback((typeIndex: number, quantity: number) => {
    ...
    updateTotalPrice(newSelectedTickets);
  }, [ticketData, selectedTickets, updateTotalPrice]);
  ...
  const applyPromoCode = useCallback(() => {
    ...
    updateTotalPrice();
  }, [promoCode, setPromoDiscount, updateTotalPrice]);
      ...
      >
        ...
        <View style={styles.content}>
          <Animated.View entering={FadeInDown.delay(100).springify()}>
            ...
            {/* No need for a button here since we have the fixed button at the bottom */}
