  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.underDevelopmentContainer}>
        <Ionicons name="construct-outline" size={80} color="#6C63FF" />
        <Text style={styles.underDevelopmentTitle}>Page Under Development</Text>
        <Text style={styles.underDevelopmentText}>This feature is currently being built. Check back soon!</Text>
      </View>
    </View>
  );
};
